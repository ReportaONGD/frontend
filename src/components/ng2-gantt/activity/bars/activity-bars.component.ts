...
export class GanttActivityBarsComponent implements OnInit {
    ...
    private drawBar(task: any, index: number) {
        ...
        if (this.zoomLevel === Zooming[Zooming.hours]) {
          style = this.ganttService.calculateBar(task, index, this.timeScale, true, false);
        } else if (this.zoomLevel === Zooming[Zooming.month]) {
            style = this.ganttService.calculateBar(task, index, this.timeScale, false, true);
        } else {
            style = this.ganttService.calculateBar(task, index, this.timeScale, false, false);
        }
        return style;
    }
