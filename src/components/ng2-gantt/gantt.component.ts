    ...
    template: `
        <div style="width: 100%">
            <div class="gantt_container" (window:resize)="onResize($event)">
                <gantt-header [name]="_project.name" [startDate]="_project.startDateString" [endDate]="_project.endDateString"></gantt-header>
                <gantt-activity [project]="_project" [options]="_options" (onGridRowClick)="gridRowClicked($event)" (editCronograma)="edit($event)"></gantt-activity>
...
export class GanttComponent implements OnInit {
    ...
    edit(value) {
      this.editCronograma.emit(value);
    }
}
