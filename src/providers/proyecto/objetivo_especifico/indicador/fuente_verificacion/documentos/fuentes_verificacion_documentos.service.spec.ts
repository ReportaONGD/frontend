...
import { ObjetivoEspecificoFuenteVerificacionDocumentoService } from './fuentes_verificacion_documentos.service';

describe('Service: Documento Objetivo Especifico', () => {
  let service: ObjetivoEspecificoFuenteVerificacionDocumentoService;
  const ids = {
  ...
  beforeEach(() => {
    // const spy = jasmine.createSpyObj('ObjetivoEspecificoFuenteVerificacionDocumentoService', ['all']);
    ...
    service = TestBed.get(ObjetivoEspecificoFuenteVerificacionDocumentoService);
    service.ids = ids;
  });
  ...
  it('get all documentos from project, returns Array<DocumentosModel>', () => {
