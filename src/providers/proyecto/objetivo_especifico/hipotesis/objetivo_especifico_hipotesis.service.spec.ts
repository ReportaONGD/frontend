...
describe('Service: Hipotesis Objetivo Especifico', () => {
  ...
  beforeEach(() => {
    ...
    service = TestBed.get(ObjetivoEspecificoHipotesisService);
    service.ids = ids;
  });
  ...
  it('get all hipotesis from one objetivo especifico , returns Array<HipotesisModel>', () => {
