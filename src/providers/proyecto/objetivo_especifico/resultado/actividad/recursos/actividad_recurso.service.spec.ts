...
import { ActividadRecursoService } from './actividad_recurso.service';
import { Observable } from 'rxjs/Observable';
import { RecursoModel } from '../../../../../../models/recurso.model';

describe('Service: Recurso Actividad', () => {
  let service: ActividadRecursoService;
  ...
  beforeEach(() => {
    ...
    service = TestBed.get(ActividadRecursoService);
  });
