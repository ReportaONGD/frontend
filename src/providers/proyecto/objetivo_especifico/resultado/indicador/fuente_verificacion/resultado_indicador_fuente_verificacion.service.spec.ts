...
import { ResultadoFuenteVerificacionService } from './resultado_fuente_verificacion.service';
...
describe('Service: Fuente Verificacion Indicador Resultado', () => {
  let service: ResultadoFuenteVerificacionService;
  const ids = {
  ...
  beforeEach(() => {
    ...
    service = TestBed.get(ResultadoFuenteVerificacionService);
    service.ids = ids;
  });
