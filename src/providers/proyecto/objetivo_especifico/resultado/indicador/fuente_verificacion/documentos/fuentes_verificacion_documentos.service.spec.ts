...
import { ResultadoFuenteVerificacionDocumentoService } from './fuentes_verificacion_documentos.service';

describe('Service: Documento Resultado', () => {
  let service: ResultadoFuenteVerificacionDocumentoService;
  const ids = {
  ...
  beforeEach(() => {
    // const spy = jasmine.createSpyObj('ResultadoFuenteVerificacionDocumentoService', ['all']);
    ...
    service = TestBed.get(ResultadoFuenteVerificacionDocumentoService);
    service.ids = ids;
  });
