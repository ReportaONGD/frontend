...
import { ResultadoIndicadorService } from './resultado_indicador.service';
import { Observable } from 'rxjs/Observable';
import { IndicadorModel } from '../../../../../models/indicador.model';

describe('Service: Indicador Resultado', () => {
  let service: ResultadoIndicadorService;
  const ids = {
  ...
  beforeEach(() => {
    ...
    service = TestBed.get(ResultadoIndicadorService);
    service.ids = ids;
  });
  ...
  it('get all indicadores from one resultado returns Array<IndicadorModel>', () => {
