...
import { ObjetivoFuenteVerificacionDocumentosService } from './fuentes_verificacion_documentos.service';

describe('Service: Documento Objetivo', () => {
  let service: ObjetivoFuenteVerificacionDocumentosService;
  const ids = {
  ...
  beforeEach(() => {
    // const spy = jasmine.createSpyObj('ObjetivoFuenteVerificacionDocumentosService', ['all']);
    ...
    service = TestBed.get(ObjetivoFuenteVerificacionDocumentosService);
    service.ids = ids;
  });
