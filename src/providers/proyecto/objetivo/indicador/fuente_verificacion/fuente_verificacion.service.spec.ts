...
describe('Service: Indicador Objetivo Generico', () => {
  ...
  beforeEach(() => {
    ...
    service = TestBed.get(OGFuenteVerificacionService);
    service.ids = ids;
  });
