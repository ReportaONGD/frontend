...
import { GastosDocumentosService } from './gastos_documentos.service';

describe('Service: Documento', () => {
  let service: GastosDocumentosService;
  const ids = {
  ...
  beforeEach(() => {
    // const spy = jasmine.createSpyObj('GastosDocumentosService', ['all']);
    ...
    service = TestBed.get(GastosDocumentosService);
    service.ids = ids;
  });
